                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $customer->email }}" name="email" id="phone"
                                            class="form-control" placeholder="Phone">
                                    </div>
                                    <div class="mb-3">
                                        <label for="driving_license">Driving_license</label>
                                        <input type="text" value="{{ $customer->driving_license }}"
                                            name="driving_license" id="driving_license" class="form-control"
